...
def createSensors(nodeId: str, hadevice: HADevice, qos: int):
    ...
    sensors.append(createBlueprint(HASensor, nodeId, hadevice, "BSZ EQ Betriebsstunden", device_class=HADeviceClassSensor.DURATION, unit_of_measurement="h", icon="mdi:wrench-clock"))
    sensors.append(createBlueprint(HASensor, nodeId, hadevice, "BSZ EQ Schaltungen", icon="mdi:counter"))
    sensors.append(createBlueprint(HASensor, nodeId, hadevice, "BSZ HKP Betriebsstunden", device_class=HADeviceClassSensor.DURATION, unit_of_measurement="h", icon="mdi:wrench-clock"))
    sensors.append(createBlueprint(HASensor, nodeId, hadevice, "BSZ HKP Schaltung", icon="mdi:counter"))
    sensors.append(createBlueprint(HASensor, nodeId, hadevice, "BSZ Verdichter akt. Laufzeit", device_class=HADeviceClassSensor.DURATION, unit_of_measurement="h", icon="mdi:wrench-clock"))
    sensors.append(createBlueprint(HASensor, nodeId, hadevice, "BSZ Verdichter Betriebsst. ges", device_class=HADeviceClassSensor.DURATION, unit_of_measurement="h", icon="mdi:wrench-clock"))
    sensors.append(createBlueprint(HASensor, nodeId, hadevice, "BSZ Verdichter Betriebsst. HKR", device_class=HADeviceClassSensor.DURATION, unit_of_measurement="h", icon="mdi:wrench-clock"))
    sensors.append(createBlueprint(HASensor, nodeId, hadevice, "BSZ Verdichter Betriebsst. WW", device_class=HADeviceClassSensor.DURATION, unit_of_measurement="h", icon="mdi:wrench-clock"))
    ...
    sensors.append(createBlueprint(HASensor, nodeId, hadevice, "Frischwasserpumpe", enabled_by_default=False))
    ...
    sensors.append(createBlueprint(HABinarySensor, nodeId, hadevice, "FWS Type", enabled_by_default=False))
    ...
    sensors.append(createBlueprint(HASensor, nodeId, hadevice, "HKR Absenktemp. (K)", device_class=HADeviceClassSensor.TEMPERATURE, unit_of_measurement="K", icon="mdi:thermometer-chevron-down"))
    sensors.append(createBlueprint(HASensor, nodeId, hadevice, "HKR Aufheiztemp. (K)", device_class=HADeviceClassSensor.TEMPERATURE, unit_of_measurement="K", icon="mdi:thermometer-chevron-up"))
    ...
    sensors.append(createBlueprint(HABinarySensor, nodeId, hadevice, "Puffer Type", enabled_by_default=False))
